...
const ComposeMail = () => {
  ...
  const handleSendMail = async (event) => {
    ...
    try {
      ...
      await axios.post(
        `https://mail-box-client-2b50e-default-rtdb.firebaseio.com/inbox/${receivedEmail}.json`,
        {
          from: senderEmail,
          subject: subject,
          message: message,
      ...
      await axios.post(
        `https://mail-box-client-2b50e-default-rtdb.firebaseio.com/client/${senderEmail}.json`,
        {
          sendTo: recipient,
          subject: subject,
          message: message,
